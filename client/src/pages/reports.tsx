...
export default function Reports() {
  ...
  const getReportData = () => {
    ...
    const averageHoursPerDay = filteredEntries.length > 0 ? totalHours / filteredEntries.length : 0;
    ...
    const employeesWithData = employees.map(employee => {
      ...
      const employeeIncidents = filteredIncidents.filter(incident => incident.employeeId === employee.id);
      const employeeHours = employeeEntries.reduce((sum, entry) => sum + (entry.totalHours || 0), 0);
      ...
      return {
        ...
        averageHours: employeeEntries.length > 0 ? employeeHours / employeeEntries.length : 0,
      };
    });
    ...
    return (
      <div className="p-4 lg:p-6 space-y-6">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground">Genera y exporta reportes detallados</p>
        </div>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div>
              ...
              <Select value={selectedPeriod} onValueChange={setSelectedPeriod} data-testid="select-report-period">
                <SelectTrigger>
            ...
            <div>
              ...
              <Select value={selectedEmployee} onValueChange={setSelectedEmployee} data-testid="select-employee-filter">
                <SelectTrigger>
          ...
          <div className="flex gap-2 mt-4">
            <Button onClick={() => exportReport("pdf")} data-testid="button-export-pdf">
              ...
              <CardContent className="p-6">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold" data-testid="report-total-employees">
              ...
              <CardContent className="p-6">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold" data-testid="report-total-hours">
              ...
              <CardContent className="p-6">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold" data-testid="report-total-days">
              ...
              <CardContent className="p-6">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold" data-testid="report-total-incidents">
                  ...
                  >
                    ...
                    <div className="text-right">
                      <p className="text-lg font-semibold">
                        {Math.floor(employee.averageHours / 60)}h {employee.averageHours % 60}m
                      </p>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-border">
                      ...
                      <th className="text-left py-3 px-4 font-medium text-muted-foreground">Total Horas</th>
                      <th className="text-left py-3 px-4 font-medium text-muted-foreground">Días Trabajados</th>
                      <th className="text-left py-3 px-4 font-medium text-muted-foreground">Promedio/Día</th>
                  ...
                  <tbody>
                    {reportData.employeesWithData
                      ...
                      .map((employee) => (
                      <tr key={employee.id} className="border-b border-border hover:bg-muted/50" data-testid={`employee-report-row-${employee.id}`}>
                        ...
                        <td className="py-3 px-4 text-foreground">
                          {Math.floor(employee.totalHours / 60)}h {employee.totalHours % 60}m
                        </td>
                        <td className="py-3 px-4 text-foreground">{employee.totalDays}</td>
                        <td className="py-3 px-4 text-foreground">
                          {Math.floor(employee.averageHours / 60)}h {employee.averageHours % 60}m
                        </td>
                        <td className="py-3 px-4 text-foreground">{employee.totalIncidents}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
