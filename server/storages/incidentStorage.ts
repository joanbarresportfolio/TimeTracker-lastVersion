...
export async function updateIncident(id: string, incidentData: Partial<InsertIncident>): Promise<Incident | undefined> {
  ...
  if (incidentData.idUser !== undefined) updateData.idUser = incidentData.idUser;
  if (incidentData.idDailyWorkday !== undefined) updateData.idDailyWorkday = incidentData.idDailyWorkday;
  if (incidentData.description !== undefined) updateData.description = incidentData.description;
  if (incidentData.idIncidentsType !== undefined) updateData.idIncidentsType = incidentData.idIncidentsType;
